...
2. Clone this repository: git clone https://docs.docker.com/compose/install/
...
4. Use your favorite text editing tool to change the following values in the docker-compose.yml file
  ...
  2. Specify the IP address you are running the server in the `PIX_URL:` section of the `worker` and `server`
